...
RANKING_REPLAY_RUN_ID="server_v2_attack_scoreable_input_repair_size_balanced_msa_reuse_protenix25_seed101_125_ranking_consensus_replay"
...
RANKING_REPLAY_QA_CSV="diagnostics/selection_qa/server_v2_attack_scoreable_input_repair_size_balanced_msa_reuse_protenix25_seed101_125_ranking_consensus_replay.selection_qa.csv"
POST_P25_READOUT_JSON="diagnostics/score_probes/server_v2_attack_scoreable_input_repair_size_balanced_msa_reuse_protenix25_seed101_125.post_p25_readout.json"
...
args=(
  ...
  --replay-run-id "${RANKING_REPLAY_RUN_ID}"
  --replay-selected-model-policy "protenix_ranking_consensus_v1"
  --replay-strategy "scoreable_target_subset_input_repair_v1_ranking_consensus_selector_replay"
  --replay-selection-qa-output-csv "${RANKING_REPLAY_QA_CSV}"
  --post-p25-readout-output-json "${POST_P25_READOUT_JSON}"
