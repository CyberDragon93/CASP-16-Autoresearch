...
/scratch/10992/liaorunlong93/conda/envs/protein/bin/protenix pred -i /scratch/10992/liaorunlong93/casp16-leaderboard/runs/server_v2_attack_scoreable_size_balanced_shard02_msa_reuse_protenix25_seed116_120/inputs/scoreable_size_balanced_02.inputs.msa-reuse.json -o /scratch/10992/liaorunlong93/casp16-leaderboard/runs/server_v2_attack_scoreable_size_balanced_shard02_msa_reuse_protenix25_seed116_120/predictions/protenix-v2 -s 116,117,118,119,120 -e 1 -d bf16 -n protenix-v2 --use_msa true --use_template true --use_default_params false --trimul_kernel torch --triatt_kernel torch --enable_cache true --enable_fusion true --enable_tf32 true
