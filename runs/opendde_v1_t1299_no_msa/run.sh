...
'/scratch/10992/liaorunlong93/conda/envs/protein/bin/opendde' 'pred' '-i' '/scratch/10992/liaorunlong93/casp16-leaderboard/runs/opendde_v1_t1299_no_msa/inputs/T1299.json' '-o' '/scratch/10992/liaorunlong93/casp16-leaderboard/runs/opendde_v1_t1299_no_msa/predictions/opendde_v1' '-n' 'opendde_v1' '--seeds' '101' '--use_msa' 'false' '--use_template' 'false' '--use_rna_msa' 'false' '--sample' '1' '--step' '200' '--cycle' '10' '--dtype' 'fp32' '--trimul_kernel' 'auto' '--triatt_kernel' 'auto' '--enable_cache' 'true' '--enable_fusion' 'true' '--enable_tf32' 'true'
