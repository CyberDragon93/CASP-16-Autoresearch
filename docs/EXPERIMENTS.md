...
| `server_attack_protenix_terminal_tag_seed101_105` | `casp16_server_protein_v1` | Slurm job `810719` running; 98/98/98/48/0 CIFs by seed at `2026-07-06 20:16 CDT`; partial diagnostic score is domain `0.044437`, oligo `0.000000` | five-seed terminal-tag cleanup attack run with predeclared confidence-only model selection | attack tier only; partial result is weak and should not be scaled |
