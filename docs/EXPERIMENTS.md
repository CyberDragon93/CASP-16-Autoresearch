...
| `targetlab_protenix_yang_antibody_fv_seed101` | target_lab only | Slurm job `811918` pending on resources at `2026-07-06 18:04 CDT` | eight Fv-only antibody-antigen target-lab jobs from `yang_antibody_fv_fragment_inputs_v1` | not rank eligible |
