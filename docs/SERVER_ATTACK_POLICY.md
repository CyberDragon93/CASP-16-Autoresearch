...
an overlay. The current live launch gate is P25, checked `2026-07-07 15:05
...
reports `ready=false`, `compatible=true`, `1269` observed candidates, `789`
shard-level candidates missing, and `719` full 25-candidate slots missing.
