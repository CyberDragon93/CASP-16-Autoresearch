...
an overlay. The current live launch gate is P25, checked `2026-07-07 15:00
...
reports `ready=false`, `compatible=true`, `1267` observed candidates, `791`
shard-level candidates missing, and `721` full 25-candidate slots missing.
