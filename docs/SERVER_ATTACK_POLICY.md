...
an overlay. The current live launch gate is P25, checked `2026-07-07 14:57
...
reports `ready=false`, `compatible=true`, `1261` observed candidates, `797`
shard-level candidates missing, and `727` full 25-candidate slots missing.
