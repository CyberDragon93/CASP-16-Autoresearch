...
Current live P25 gate, checked `2026-07-07 15:08 CDT`: `ready=false`,
`compatible=true`, `1278` observed candidates, `780` shard-level candidates
missing, and `710` full 25-candidate slots missing. One target is now complete
