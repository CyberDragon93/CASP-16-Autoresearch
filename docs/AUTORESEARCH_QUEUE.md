...
Current live P25 gate, checked `2026-07-07 15:37 CDT`: `ready=false`,
`compatible=true`, `1357` observed candidates, `701` shard-level candidates
missing, and `631` full 25-candidate slots missing. One target is now complete
