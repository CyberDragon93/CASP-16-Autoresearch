...
Current live P25 gate, checked `2026-07-07 13:29 CDT`: `ready=false`,
`compatible=true`, `1037` observed candidates, `1013` shard-level candidates
missing, and `943` full 25-candidate slots missing. One target is now complete
