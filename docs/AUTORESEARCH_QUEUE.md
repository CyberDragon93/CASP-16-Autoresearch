...
Current live P25 gate, checked `2026-07-07 15:27 CDT`: `ready=false`,
`compatible=true`, `1353` observed candidates, `705` shard-level candidates
missing, and `635` full 25-candidate slots missing. One target is now complete
