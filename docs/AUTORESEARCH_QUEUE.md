...
| target_lab | `811918` | `targetlab_protenix_yang_antibody_fv_seed101` | target_lab only | Slurm job pending on resources at `2026-07-06 18:04 CDT` | Eight full-MSA/template Fv-only antibody-antigen jobs from `yang_antibody_fv_fragment_inputs_v1`; diagnostic for O5, never ranked |
...
| target_lab | `811918` | `targetlab_protenix_yang_antibody_fv_seed101` | `runs/targetlab_protenix_yang_antibody_fv_seed101/` | target_lab only | pending on resources at `2026-07-06 18:04 CDT` | Eight full-MSA/template Fv-only antibody-antigen jobs; diagnostic for O5, never ranked |
