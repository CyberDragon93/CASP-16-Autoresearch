...
Current live P25 gate, checked `2026-07-07 15:56 CDT`: `ready=false`,
`compatible=true`, `1388` observed candidates, `670` shard-level candidates
missing, and `603` full 25-candidate slots missing. Four targets are now complete
