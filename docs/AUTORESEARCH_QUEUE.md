...
Current live P25 gate, checked `2026-07-07 12:47 CDT`: `ready=false`,
`compatible=true`, `886` observed candidates, `1164` shard-level candidates
missing, and `1089` full 25-candidate slots missing. Slurm has 19 P25 jobs
...
not repeated MSA recomputation.
