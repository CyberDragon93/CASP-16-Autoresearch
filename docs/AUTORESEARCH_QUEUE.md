...
| P14 | `target_lab/small_complex_stoich_batch_v1` | target_lab only | Slurm job `810824` failed; resubmitted as `811114` pending | Compact batch for exact stoichiometry plus H1258 window learning | Monitor resubmitted job; do not register as ranked |
