...
`compatible=true`, `858` observed candidates, `1192` shard-level candidates
missing, and `1117` full 25-candidate slots missing. Slurm has 19 P25 jobs
...
Current running shard logs show normal large-complex inference, not MSA
recomputation: `H0258`, `H1258`, `H2258`, `H0272`, and `H1272` are the active
slow targets.
