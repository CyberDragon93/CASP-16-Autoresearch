...
| P14 | `server_v2_protenix_yang_oligo_sequence_stoich_hydrophobic_leader_nofail_msa_reuse_seed101` | `casp16_server_protein_v2_aliasfix` | pending, not submitted | Narrow D1d construct-cleanup ablation on the current nofail stack: trims signal-like hydrophobic leaders on 8 T0240/T1210/T1240 alias jobs, keeps 165 jobs and 0 over-token, reuses 260/268 MSA paths | Run after the main v2 nofail score/attack decision, unless the current stack scores badly enough to deprioritize this branch |
...
| P13 | `server_v2_protenix_yang_oligo_sequence_stoich_hydrophobic_leader_nofail_msa_reuse_seed101` | `yang_oligo_sequence_stoich_low_complexity_hydrophobic_leader_large_fallback_v1_msa_reuse` | `runs/server_v2_protenix_yang_oligo_sequence_stoich_hydrophobic_leader_nofail_msa_reuse_seed101/` | `casp16_server_protein_v2_aliasfix` | pending, not submitted | Single-seed hydrophobic-leader cleanup on T0240/T1210/T1240 alias jobs; 8 changed sequences, 0 over-token, 260/268 MSA paths reused |
