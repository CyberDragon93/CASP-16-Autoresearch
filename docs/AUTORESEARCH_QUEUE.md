...
Current live P25 gate, checked `2026-07-07 14:37 CDT`: `ready=false`,
`compatible=true`, `1188` observed candidates, `866` shard-level candidates
missing, and `796` full 25-candidate slots missing. One target is now complete
