...
Current live P25 gate, checked `2026-07-07 16:02 CDT`: `ready=false`,
`compatible=true`, `1409` observed candidates, `649` shard-level candidates
missing, and `584` full 25-candidate slots missing. Six targets are now complete
