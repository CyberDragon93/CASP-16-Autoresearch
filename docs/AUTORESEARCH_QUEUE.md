...
Current live P25 gate, checked `2026-07-07 15:53 CDT`: `ready=false`,
`compatible=true`, `1370` observed candidates, `688` shard-level candidates
missing, and `618` full 25-candidate slots missing. One target is now complete
