...
Current live P25 gate, checked `2026-07-07 14:52 CDT`: `ready=false`,
`compatible=true`, `1258` observed candidates, `800` shard-level candidates
missing, and `730` full 25-candidate slots missing. One target is now complete
