...
| P13 | `server_v2_attack_scoreable_oligo_recovery_msa_reuse_protenix5_seed101_105` | `casp16_server_protein_v2_aliasfix` | Slurm job `811751` running on `c636-072`; `2026-07-06 20:27 CDT` diagnostic has 36 seed101 CIFs, domain mean `0.099576`, oligo mean `0.028394`, and new nonzero rows `H1202=0.924`, `H0272=0.428`, `H1204=0.421` | Compute-saving five-candidate attack on the current strongest v2 nofail stack: filters prediction inputs to 74/165 jobs and reuses 141/141 exact-sequence MSA paths; exact H-oligo signal is now clearly useful | Keep running while productive. Score only after all five declared seeds complete; P14 remains the cleaner scheduler because it reaches the same exact-oligo class with less early large-target latency |
