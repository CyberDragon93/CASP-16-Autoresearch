...
Current live P25 gate, checked `2026-07-07 15:05 CDT`: `ready=false`,
`compatible=true`, `1269` observed candidates, `789` shard-level candidates
missing, and `719` full 25-candidate slots missing. One target is now complete
