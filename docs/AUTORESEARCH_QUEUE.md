...
Current live P25 gate, checked `2026-07-07 13:24 CDT`: `ready=false`,
`compatible=true`, `1014` observed candidates, `1036` shard-level candidates
missing, and `966` full 25-candidate slots missing. One target is now complete
