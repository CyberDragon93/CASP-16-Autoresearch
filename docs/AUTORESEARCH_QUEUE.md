...
| P13 | `server_v2_attack_scoreable_oligo_recovery_msa_reuse_protenix5_seed101_105` | `casp16_server_protein_v2_aliasfix` | Slurm job `811751` running on `c636-072`; `2026-07-06 19:21 CDT` check still has 32 seed101 CIFs and is on large target `H0258` as item 33/74 | Compute-saving five-candidate attack on the current strongest v2 nofail stack: filters prediction inputs to 74/165 jobs and reuses 141/141 exact-sequence MSA paths; exact H-oligo signal is now real: H0223 QSglob `0.591`, H0225 `0.270`, H0233 `0.221` | Keep running; do not cancel for P14 unless P13 fails or stalls. Score only after all five declared seeds complete |
