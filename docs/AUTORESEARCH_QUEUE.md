...
Current live P25 gate, checked `2026-07-07 15:23 CDT`: `ready=false`,
`compatible=true`, `1348` observed candidates, `710` shard-level candidates
missing, and `640` full 25-candidate slots missing. One target is now complete
