...
Current live P25 gate, checked `2026-07-07 13:13 CDT`: `ready=false`,
`compatible=true`, `996` observed candidates, `1054` shard-level candidates
missing, and `984` full 25-candidate slots missing. One target is now complete
