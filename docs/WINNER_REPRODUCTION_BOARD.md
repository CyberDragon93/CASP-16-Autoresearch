...
Checked `2026-07-07 14:37 CDT`: P25 is still incomplete, but the live jobs
look healthy.
...
| observed candidates | `1188` |
| shard-level missing candidates | `866` |
| full 25-candidate slots still missing | `796` |
