...
Checked `2026-07-07 15:00 CDT`: P25 is still incomplete, but the live jobs
look healthy.
...
| observed candidates | `1267` |
| shard-level missing candidates | `791` |
| full 25-candidate slots still missing | `721` |
