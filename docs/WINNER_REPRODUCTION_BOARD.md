...
Checked `2026-07-07 15:05 CDT`: P25 is still incomplete, but the live jobs
look healthy.
...
| observed candidates | `1269` |
| shard-level missing candidates | `789` |
| full 25-candidate slots still missing | `719` |
