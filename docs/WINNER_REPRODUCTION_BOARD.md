...
Checked `2026-07-07 14:57 CDT`: P25 is still incomplete, but the live jobs
look healthy.
...
| observed candidates | `1261` |
| shard-level missing candidates | `797` |
| full 25-candidate slots still missing | `727` |
