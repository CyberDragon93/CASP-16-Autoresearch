...
Checked `2026-07-07 14:34 CDT`: P25 is still incomplete, but the live jobs
look healthy.
...
| observed candidates | `1171` |
| shard-level missing candidates | `881` |
| full 25-candidate slots still missing | `811` |
