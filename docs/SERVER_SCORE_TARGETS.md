...
Latest live checkpoint, `2026-07-07 15:00 CDT`: P25 is still not merge-ready.
...
missing, and `721` full 25-candidate slots missing. Slurm still has 19 P25
...
Current live P25 status, checked `2026-07-07 15:00 CDT`: P17 overlay is merged
...
`compatible=true`, with 1267 observed candidates, 791 shard-level candidates
missing, and 721 full merged candidate slots still missing. Shard05
