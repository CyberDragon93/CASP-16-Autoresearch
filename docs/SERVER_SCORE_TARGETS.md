...
Latest live checkpoint, `2026-07-07 15:14 CDT`: P25 is still not merge-ready.
...
missing, and `691` full 25-candidate slots missing. Slurm still has 19 P25
...
Current live P25 status, checked `2026-07-07 15:14 CDT`: P17 overlay is merged
...
`compatible=true`, with 1297 observed candidates, 761 shard-level candidates
missing, and 691 full merged candidate slots still missing. Shard05
