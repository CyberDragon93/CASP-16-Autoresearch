...
Latest live checkpoint, `2026-07-07 15:22 CDT`: P25 is still not merge-ready.
...
missing, and `647` full 25-candidate slots missing. Slurm still has 19 P25
...
Current live P25 status, checked `2026-07-07 15:22 CDT`: P17 overlay is merged
...
`compatible=true`, with 1341 observed candidates, 717 shard-level candidates
missing, and 647 full merged candidate slots still missing. Shard05
