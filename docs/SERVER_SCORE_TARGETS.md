...
Latest live checkpoint, `2026-07-07 11:27 CDT`: P25 is still not merge-ready.
`check-shards` reports `ready=false`, `compatible=true`, `656` observed
candidates, `1394` shard-level candidates missing, and `1319` full
